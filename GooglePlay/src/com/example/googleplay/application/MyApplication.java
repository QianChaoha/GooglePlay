...
//		LeakCanary.install(this);
		...
		// // 加载默认的ImageLoader
		// defaultImgLoader = new ImageLoader(mRequestQueue, new
	 ...
	 * Volley默认的错误处理程序
	 */
	// protected Response.ErrorListener defaultErrorListener = new
	// Response.ErrorListener() {
	// @Override
	// public void onErrorResponse(VolleyError volleyError) {
	// if (volleyError instanceof NetworkError) {
	// Toast.makeText(getApplicationContext(), "您的网络连接不稳定",
